...
export default function UserInfo() {
  return (
    <div className="pointer-events-none absolute left-[50%] top-[60px] z-10 ml-[-20px] w-[300px] translate-x-[-50%] rounded-lg border-2 border-solid bg-white p-[10px] opacity-0 shadow-md transition-cartoon group-hover:pointer-events-auto group-hover:opacity-100">
